...
<xsl:template name="header">
    <xsl:call-template name="header-gen">
       <xsl:with-param name="title" select="'Time to Return Your EZ-Borrow Library Materials - Overdue'"/>
    </xsl:call-template>
</xsl:template>
...
<p>According to our records, you have EZ-Borrow items that are now overdue and may be accruing fines. Please return these items before you are billed for a replacement. If you are finished using them, please return them to any of the New School Libraries.</p>
 ...
 <ul>
  ...
  <li>EZ-Borrow items should be returned with the blue bookband on the correct book.</li>
</ul> 

 <p>For a list of these EZ-Borrow items, please see below.</p>
