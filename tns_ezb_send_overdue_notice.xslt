...
<xsl:template name="reminder_message">
    ...
    <p STYLE="font-family: Arial">According to our records, you have E-ZBorrow items that are overdue and may be accruing fines.</p>
    ...
    <p STYLE="font-family: Arial;margin-bottom:0px;padding-bottom:0px;">For a list of these overdue E-ZBorrow library items, please see below.</p>
</xsl:template>
