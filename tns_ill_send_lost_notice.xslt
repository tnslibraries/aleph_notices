...
<xsl:template name="header">
    <xsl:call-template name="header-gen">
       <xsl:with-param name="title" select="'Lost Inter-Library Loan (ILL) Materials'"/>
    </xsl:call-template>
</xsl:template>
...
<p>For a list of the inter-Library Loan (ILL) items in question, please see below.</p>
</pre>
...
<xsl:template name="addrs">
        ...
        <xsl:call-template name="generic-line">
       <xsl:with-param name="line" select="'Please contact The New School Libraries staff with questions or concerns about inter-Library Loan (ILL) at:'"/>
    </xsl:call-template>
