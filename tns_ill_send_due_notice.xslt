<xsl:stylesheet
  ...
  <xsl:template name="header">
    <xsl:call-template name="header-gen">
      <xsl:with-param name="title" select="'Time to Return Your Inter-Library Loan (ILL) Materials - Due Today'"/>
    </xsl:call-template>
  </xsl:template>
  ...
  <xsl:template name="reminder_message">
    ...
    <p STYLE="font-family: Arial">According to our records, you have Inter-Library Loan (ILL) items that are due today.</p>
    ...
    <p STYLE="font-family: Arial;margin-bottom:0px;padding-bottom:0px;">For a list of these Inter-Library Loan (ILL) items, please see below.</p>
  </xsl:template>
