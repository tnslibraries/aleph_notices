<xsl:stylesheet
    ...
    <xsl:template name="header">
        <xsl:call-template name="header-gen">
            <xsl:with-param name="title" select="'Time to Return Your Library Materials - Due Today'"/>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template name="reminder_message">
        ...
        <p STYLE="font-family: Arial">According to our records, you have library items that are due today.</p>
