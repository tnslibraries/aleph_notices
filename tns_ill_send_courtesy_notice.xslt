...
<xsl:template name="header">
    <xsl:call-template name="header-gen">
       <xsl:with-param name="title" select="'Time to Return Your Inter-Library Loan (ILL) Library Materials - Due Soon'"/>
    </xsl:call-template>
</xsl:template>
...
<xsl:template name="addrs">
        ...
        <xsl:call-template name="generic-line">
       <xsl:with-param name="line" select="'Please contact The New School Libraries staff with questions or concerns about Inter-Library Loan materials at:'"/>
    </xsl:call-template>
