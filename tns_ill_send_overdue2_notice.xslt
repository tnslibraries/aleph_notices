...
<xsl:template name="header">
    <xsl:call-template name="header-gen">
       <xsl:with-param name="title" select="'Time to Return Your Inter-Library Loan Library Materials - Severely Overdue'"/>
    </xsl:call-template>
</xsl:template>
...
According to our records, you have Inter-Library Loan items that are severely overdue and may be accruing fines. Please return these items before you are billed for a replacement. If you are finished using them, please return them to any of the New School Libraries.
